...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('courses', '0005_auto_20200407_1754'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enrollments', to='courses.Course', verbose_name='Usuario')),
