...
from django.urls import reverse #para funcionar permalink
...
class Comment(models.Model):
    ...
    announcement = models.ForeignKey(
        Announcement, verbose_name='Anuncio', related_name='comments', on_delete=models.CASCADE
    )
...
def post_save_announcement(instance, created, **kwarrgs):
    if created:
...
models.signals.post_save.connect(
    post_save_announcement, sender=Announcement, dispatch_uid='post_save_annoucement'
    )
